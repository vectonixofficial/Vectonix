    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    <div
                        className="relative w-[75vw] h-[75vh] pointer-events-auto overflow-hidden rounded-2xl border border-white/20 bg-transparent backdrop-blur-3xl shadow-[0_0_50px_rgba(0,0,0,0.7)] p-8 flex flex-col cursor-default"
                    ...
                    >
                        ...
                        <div className="absolute top-6 right-6 z-50">
                            <button
                                onClick={handleClose}
                                className="text-gray-400 hover:text-white hover:bg-white/10 transition-all p-2 rounded-full active:scale-95"
