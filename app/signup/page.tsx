            ...
            >
                <div className="glass-panel p-8 rounded-2xl border border-slate-200 shadow-xl">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500">Join Vectonix for managing events</p>
                    </div>
                    ...
                    >
                        <svg className="w-5 h-5" viewBox="0 0 24 24">
                            ...
                            <path fill="#4285F4" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
                        </svg>
                        Google
                    </Button>
