                ...
                <Section className="relative z-10 text-center">
                    <MotionWrapper delay={0.1}>
                        <h1 className="text-5xl md:text-8xl font-bold text-slate-900 mb-8 tracking-tight">
                            Architecting the <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-sky-500">Future</span>
                        </h1>
                    </MotionWrapper>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
                    <MotionWrapper direction="right" delay={0.2} className="h-full">
                        <div className="glass-panel glass-panel-hover p-10 rounded-3xl h-full">
                            <h3 className="text-indigo-600 font-mono text-sm uppercase tracking-widest mb-4">Our Mission</h3>
                            <h2 className="text-3xl font-bold text-slate-900 mb-6">Simplifying Life Through Innovation</h2>
                    ...
                    <MotionWrapper direction="left" delay={0.4} className="h-full">
                        <div className="glass-panel glass-panel-hover p-10 rounded-3xl h-full">
                            <h3 className="text-indigo-600 font-mono text-sm uppercase tracking-widest mb-4">Our Vision</h3>
                            <h2 className="text-3xl font-bold text-slate-900 mb-6">Global Leader in Smart Tech</h2>
                            <p className="text-slate-500 text-lg leading-relaxed">
